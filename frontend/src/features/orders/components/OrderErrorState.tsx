...
export function OrderErrorState({ message, loading, onRetry }: OrderErrorStateProps) {
  return (
    <section className="rounded-2xl border border-red-200 bg-red-50 p-6 shadow-panel transition-all duration-200 hover:border-red-300 hover:shadow-md">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex gap-3">
          ...
          <div>
            <h3 className="text-base font-semibold text-slate-950">No fue posible cargar los pedidos</h3>
