...
type CarrierErrorStateProps = {
  message: string;
  loading: boolean;
  onRetry: () => void;
};

export function CarrierErrorState({ loading, message, onRetry }: CarrierErrorStateProps) {
  return (
    <section className="rounded-2xl border border-red-200 bg-red-50 p-6 shadow-panel">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex gap-3">
          ...
          <div>
            <h3 className="text-base font-semibold text-red-950">No fue posible cargar transportistas</h3>
