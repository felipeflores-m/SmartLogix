...
export function WarehouseErrorState({ loading, message, onRetry }: WarehouseErrorStateProps) {
  return (
    <section className="rounded-2xl border border-red-200 bg-red-50 px-5 py-8 shadow-panel">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex gap-3">
          ...
          <div>
            <h3 className="text-base font-semibold text-red-950">No fue posible cargar bodegas</h3>
